#
#  Be sure to run `pod spec lint CPTutorial.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "can16358p"
  # s.authors            = { "can16358p" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/can16358p/CPTutorial.git", :commit => "e2a2822091cbe7b6fe90cecc68922fb35fe93607" }
